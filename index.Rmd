...
1. COVID-19 forced me to [become a chef](https://www.instagram.com/stories/highlights/17858971267858352/?hl=en). Results are mixed.
1. I got involved in the 2020 election by prototyping a mail-in dropoff tool in [R Shiny](https://arifyali.shinyapps.io/mail-in-ballot-dropoff/) and was able to work with volunteers via [Tech For Campaigns](https://techforcampaigns.org/) to make it a [full blown product](https://ballotdropoff.techforcampaigns.io/) (please note, the url redirects to [iwillvote.com](iwillvote.com/locate))!
