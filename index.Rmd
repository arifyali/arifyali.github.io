...
1. Planning on leverage {rvest} the [Instagram Basic Display API](https://developers.facebook.com/docs/instagram-basic-display-api), and the Google Place API to grab the geotags of my posts and map them out.
